...
<acme:form>
	...
	<%--<acme:form-moment code="anonymous.shout.form.label.Xdate" path="Xdate"/>--%>
	<acme:form-textbox code="anonymous.shout.form.label.Xdate" path="XdateString" placeholder="dd-MM-YYYY"/>
