...
<acme:form>
	...
	<acme:form-money code="anonymous.shout.label.budget" path="budget"/>
	<acme:form-moment   code="anonymous.shout.label.deadline" path="deadline"/>
	<acme:form-checkbox code="anonymous.shout.label.important" path="important" />
