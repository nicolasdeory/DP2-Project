...
<acme:list readonly="true">
	...
	<acme:list-column code="anonymous.shout.label.corchudentifier" path="corchudentifier" width="20%" sortable="false"/>
	...
	<acme:list-column code="anonymous.shout.label.evaluationdate" path="evaluationdate" width="20%" sortable="false"/>
