...
<table class="table table-sm">
	...
	<tr>
		<th scope="row">
			<acme:message code="administrator.dashboard.form.label.corchuFlaggedAsImportant"/>
		</th>
		<td>
			<acme:print value="${corchuFlaggedAsImportant}"/>
		</td>
	</tr>
	<tr>
		<th scope="row">
	...
	<tr>
		<th scope="row">
			<acme:message code="administrator.dashboard.form.label.corchu_EURBudgetAverage"/>
		</th>
		<td>
			<acme:print value="${corchu_EURBudgetAverage}"/>
		</td>
	</tr>
	<tr>
		<th scope="row">
			<acme:message code="administrator.dashboard.form.label.corchu_EURBudgetDeviation"/>
		</th>
		<td>
			<acme:print value="${corchu_EURBudgetDeviation}"/>
		</td>
	</tr>
	<tr>
		<th scope="row">
			<acme:message code="administrator.dashboard.form.label.corchu_DollarBudgetAverage"/>
		</th>
		<td>
			<acme:print value="${corchu_DollarBudgetAverage}"/>
		</td>
	</tr>
	<tr>
		<th scope="row">
			<acme:message code="administrator.dashboard.form.label.corchu_DollarBudgetDeviation"/>
		</th>
		<td>
			<acme:print value="${corchu_DollarBudgetDeviation}"/>
		</td>
	</tr>
	<tr>
		<th scope="row">
			<acme:message code="administrator.dashboard.form.label.corchu_GBPBudgetAverage"/>
		</th>
		<td>
			<acme:print value="${corchu_GBPBudgetAverage}"/>
		</td>
	</tr>
	<tr>
		<th scope="row">
			<acme:message code="administrator.dashboard.form.label.corchu_GBPBudgetDeviation"/>
		</th>
		<td>
			<acme:print value="${corchu_GBPBudgetDeviation}"/>
		</td>
	</tr>
