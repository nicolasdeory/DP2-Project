package acme.testing.anonymous.corchu;
...
class AnonymousCreateCorchuTest extends AcmeTest {
    ...
    // correctamente
    @ParameterizedTest
    @CsvFileSource(resources = "/anonymous/corchu/CreatePositive.csv", encoding = "utf-8", numLinesToSkip = 1)
    @Order(10)
    void CreatePositive(final int recordIndex, final String author, final String info, final String text,
            final String budget, final String important, final String evaluationdate) {
        ...
        super.fillInputBoxIn("evaluationdate", evaluationdate);
        ...
        super.checkColumnHasValue(recordIndex, 7, evaluationdate);
    ...
    @ParameterizedTest
    @CsvFileSource(resources = "/anonymous/corchu/CreateNegative.csv", encoding = "utf-8", numLinesToSkip = 1)
    @Order(10)
    void CreateNegative(final int recordIndex, final String author, final String info, final String text,
            final String budget, final String flag, final String evaluationdate) {
        super.clickOnMenu("Anonymous", "Shout!");
