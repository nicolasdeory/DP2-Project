...
class AnonymousCreateGusitTest extends AcmeTest {
    ...
    // correctamente
    @ParameterizedTest
    @CsvFileSource(resources = "/anonymous/gusit/CreatePositive.csv", encoding = "utf-8", numLinesToSkip = 1)
    @Order(10)
    ...
    @ParameterizedTest
    @CsvFileSource(resources = "/anonymous/gusit/CreateNegative.csv", encoding = "utf-8", numLinesToSkip = 1)
    @Order(10)
